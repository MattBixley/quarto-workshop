...
```
Refer to @tbl-observations for the individual observations.
...
@fig-bodymass-by-species shows differences in body mass distributions across the three penguin species.
A scatter plot of bill length vs bill depth, colored by species, helps illustrate morphological differences (@fig-bill-scatter))
